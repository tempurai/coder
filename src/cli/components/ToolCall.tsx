...
import { ToolCallGroupItem, IndividualToolCall } from '../InkUI.js';
          ...
          <Box flexDirection='column'>
            ...
            {call.result && (
              <Box marginLeft={2} marginTop={1}>
                <Text color='white'>{typeof call.result === 'string' ? call.result : JSON.stringify(call.result, null, 2)}</Text>
              </Box>
            )}
          </Box>
        );
  ...
  return (
    <Box flexDirection='column' marginLeft={2} marginY={1}>
      <Box>
        ...
        <Box marginLeft={1}>
          <Text color='gray'>(ID: {call.id.substring(0, 8)}...)</Text>
        </Box>
      </Box>
